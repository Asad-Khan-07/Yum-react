...
const Body = () => {
  return (
    <>
     <div className=' relative top-10 w-full flex flex-col justify-center items-center p-2 px-30'>
        <h1 className='text-gray-900 font-bold text-[50px] leading-tight'>Main Feature</h1>
        <h3 className='text-gray-600 mt-5  text-[25px] w-[550px] text-center'>There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.</h3>
    ...
    <div className='grid grid-cols-3 grid-rows-2 mt-20 p-8 gap-28'>
      <div className=" flex flex-col gap-5">
        ...
        <h1 className='text-gray-900 text-4xl font-bold '>Crafted for Startups</h1>
        <h3 className='text-gray-600 text-1xl mt-5 font-semibold'>Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.</h3>
      </div>
      ...
      <svg width="40" height="40" viewBox="0 0 40 40" class="fill-current text-blue-600"><path opacity="0.5" d="M20.5914 34.2584C20.2394 34.5172 19.7603 34.5175 19.408 34.2593L4.19163 23.1079C3.8395 22.8498 3.36065 22.85 3.00873 23.1084L1.09802 24.5111C0.553731 24.9107 0.553731 25.7237 1.09802 26.1233L19.4082 39.5655C19.7604 39.824 20.2396 39.824 20.5918 39.5655L38.9029 26.1226C39.4469 25.7232 39.4473 24.9107 38.9036 24.5109L36.9701 23.0889C36.6177 22.8298 36.1378 22.8297 35.7854 23.0888L20.5914 34.2584Z"></path><path d="M19.408 28.931C19.7603 29.1896 20.2396 29.1894 20.5918 28.9306L36.3556 17.3466L38.8979 15.4883C39.4437 15.0894 39.4446 14.275 38.8996 13.8749L20.5918 0.43445C20.2396 0.175911 19.7604 0.175913 19.4082 0.434452L1.09706 13.8774C0.553051 14.2767 0.552712 15.0892 1.09638 15.4891L3.62222 17.3466L19.408 28.931Z"></path></svg>
        ...
        <h1 className='text-gray-900 text-4xl font-bold '>High-quality Design</h1>
        <h3 className='text-gray-600 text-1xl mt-5 font-semibold'>Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.</h3>
      </div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <svg width="40" height="40" viewBox="0 0 40 40" class="fill-current text-blue-600"><path opacity="0.5" d="M20 30C22.75 30 25 32.25 25 35C25 37.75 22.75 40 20 40C17.25 40 15 37.75 15 35C15 32.25 17.25 30 20 30ZM35 30C37.75 30 40 32.25 40 35C40 37.75 37.75 40 35 40C32.25 40 30 37.75 30 35C30 32.25 32.25 30 35 30ZM35 15C37.75 15 40 17.25 40 20C40 22.75 37.75 25 35 25C32.25 25 30 22.75 30 20C30 17.25 32.25 15 35 15Z"></path><path d="M20 15C22.75 15 25 17.25 25 20C25 22.75 22.75 25 20 25C17.25 25 15 22.75 15 20C15 17.25 17.25 15 20 15ZM20 0C22.75 0 25 2.25 25 5C25 7.75 22.75 10 20 10C17.25 10 15 7.75 15 5C15 2.25 17.25 0 20 0ZM5 30C7.75 30 10 32.25 10 35C10 37.75 7.75 40 5 40C2.25 40 0 37.75 0 35C0 32.25 2.25 30 5 30ZM5 15C7.75 15 10 17.25 10 20C10 22.75 7.75 25 5 25C2.25 25 0 22.75 0 20C0 17.25 2.25 15 5 15ZM5 0C7.75 0 10 2.25 10 5C10 7.75 7.75 10 5 10C2.25 10 0 7.75 0 5C0 2.25 2.25 0 5 0ZM35 0C37.75 0 40 2.25 40 5C40 7.75 37.75 10 35 10C32.25 10 30 7.75 30 5C30 2.25 32.25 0 35 0Z"></path></svg>
          ...
          <h1 className='text-gray-900 text-4xl font-bold '>Next.js 13 (Latest)</h1>
        <h3 className='text-gray-600 text-1xl mt-5 font-semibold'>Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.</h3>
      </div>
      <div className="flex flex-col gap-5">
      <span className='bg-gray-300 rounded-2xl w-2/12 flex h-18 items-center justify-center'>
      <svg width="40" height="42" viewBox="0 0 40 42" className="fill-current text-blue-600"><path opacity="0.5" d="M31.8943 25.3303C34.1233 25.3303 36.1497 26.1409 37.5682 27.762L39.1464 26.1839C39.4614 25.8689 39.9999 26.092 39.9999 26.5374V32.936C39.9999 33.2121 39.7761 33.436 39.4999 33.436H33.1014C32.6559 33.436 32.4328 32.8974 32.7478 32.5825L35.5418 29.7885C34.5286 28.9779 33.3128 28.37 31.8943 28.37C29.0573 28.37 26.8282 30.599 26.8282 33.436C26.8282 36.273 29.0573 38.5021 31.8943 38.5021C33.3549 38.5021 34.6511 37.844 35.6345 36.8244C35.8406 36.6107 36.1187 36.4756 36.4155 36.4756H38.6535C39.0072 36.4756 39.2477 36.833 39.0881 37.1487C37.7427 39.8107 35.0781 41.5417 31.8943 41.5417C27.4361 41.5417 23.7886 37.8941 23.7886 33.436C23.7886 28.9779 27.4361 25.3303 31.8943 25.3303Z"></path><path d="M18.7226 33.436C18.7226 31.3572 19.2513 29.4548 19.9799 27.7285C20.0541 27.5529 19.9264 27.3567 19.7358 27.3567C15.8856 27.3567 12.6433 24.1144 12.6433 20.2642C12.6433 16.414 15.8856 13.1717 19.7358 13.1717C23.586 13.1717 26.8283 16.414 26.8283 20.2642C26.8283 20.5105 27.3897 21.0054 27.6246 20.9313C28.9274 20.5206 30.2827 20.2642 31.8943 20.2642C32.775 20.2642 33.6557 20.4173 34.5364 20.5905C34.7422 20.6309 34.9339 20.4739 34.9339 20.2642C34.9339 19.8699 34.9339 19.3904 34.8787 18.9362C34.827 18.5117 34.9599 18.0636 35.3001 17.8045L38.9868 14.9955C39.3921 14.5902 39.3921 14.1849 39.1894 13.7797L35.1857 6.77316C35.153 6.71599 35.1272 6.65499 35.1021 6.59411C34.9143 6.13895 34.5848 6.08618 34.1135 6.08007C33.9863 6.07841 33.86 6.10354 33.7419 6.15079L29.3957 7.88927C29.0613 8.02302 28.6829 7.96367 28.3887 7.75599C27.6155 7.21023 26.7521 6.75466 25.8752 6.31262C25.5838 6.16573 25.3813 5.88702 25.3335 5.56423L24.6729 1.10574C24.6265 0.792572 24.6613 0.389935 24.3993 0.212245C24.2235 0.0930361 23.9828 0 23.7886 0H15.6829C15.3021 0 14.7424 0.35783 14.6762 0.73726C14.6678 0.785579 14.6661 0.834927 14.6589 0.883445L13.9492 5.67408C13.894 6.04692 13.6313 6.35205 13.2873 6.50604C12.4439 6.88359 11.673 7.42345 10.8193 7.89265C10.5647 8.03264 10.26 8.04143 9.99178 7.92966L5.73545 6.15619C5.61358 6.10541 5.48273 6.07832 5.35072 6.08016C4.8506 6.08715 4.49147 6.1485 4.13234 6.68719L0.0794975 13.7797C-0.123145 14.1849 0.0794976 14.5902 0.484782 14.9955L4.34631 17.9376C4.59456 18.1268 4.74261 18.4216 4.7079 18.7317C4.65068 19.243 4.53762 19.8101 4.53762 20.2642C4.53762 20.6648 4.53762 21.1534 4.59561 21.614C4.64767 22.0276 4.52563 22.4644 4.20164 22.7267L0.484782 25.7355C0.0794976 26.1408 0.0794978 26.5461 0.28214 26.9514L4.33498 34.0439C4.5154 34.4047 4.85644 34.4443 5.35811 34.4486C5.48532 34.4497 5.61152 34.4249 5.72964 34.3776L10.0758 32.6392C10.4102 32.5054 10.7887 32.5648 11.0829 32.7724C11.8561 33.3182 12.7195 33.7738 13.5964 34.2158C13.8878 34.3627 14.0903 34.6414 14.1381 34.9642L14.8616 39.8476C14.8688 39.8961 14.871 39.9453 14.8768 39.994C14.9222 40.3734 15.3145 40.7311 15.8856 40.7311H19.13C19.9191 40.7311 20.4065 39.8523 20.0627 39.1421C19.1998 37.3593 18.7226 35.4573 18.7226 33.436Z"></path></svg>
          ...
          <h1 className='text-gray-900 text-4xl font-bold '>Tailwind CSS</h1>
        <h3 className='text-gray-600 text-1xl mt-5 font-semibold'>Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.</h3>
      </div>
      ...
      <div className="flex flex-col gap-5">
          ...
          <h1 className='text-gray-900 text-4xl font-bold '>Fully Customizable</h1>
        <h3 className='text-gray-600 text-1xl mt-5 font-semibold'>Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.</h3>
      </div>
      ...
      <div className="flex flex-col gap-5">
          ...
          <h1 className='text-gray-900 text-4xl font-bold '>Free and Open-Source</h1>
        <h3 className='text-gray-600 text-1xl mt-5 font-semibold'>Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.</h3>
      </div>


<div className="  flex justify-center w-[85rem] items-center  flex-col mt-40">
<h1 className='text-gray-900 font-bold text-[50px] leading-tight text-center'>We are ready to help</h1>
        <h3 className='text-gray-600 mt-5  text-[25px]  text-center'>There are many variations of passages of Lorem Ipsum available but the majority have suffered alteration in some form.</h3>
  <video src="https://www.youtube.com/embed/L61p2uyiMSo?si=e570LxEFTt44mB9x" controls width={600} height={400} className='rounded-4xl mt-5'></video>
    ...
    <div className=' bg-gray-200 flex justify-evenly w-[90rem] h-36 items-center mt-50 p-20 gap-20'>
...
<h1 className='text-gray-900 font-bold text-[50px] leading-tight w-4/5'>Crafted for Startup, SaaS and Business Sites.</h1>
        ...
        <ul className='grid grid-cols-2'>
          <li className='flex items-center'>
            ...
            <span className='text-[25px]  text-gray-600'>Premium quality</span>
          </li>
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className='text-[25px]  text-gray-600'>Use for lifetime</span>
          </li>
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className='text-[25px]  text-gray-600'>Next.js</span>
          </li>
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className='text-[25px]  text-gray-600'>Rich documentation</span>
          </li>
          <li className='flex items-center'>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className='text-[25px]  text-gray-600'>Tailwind CSS</span>
          </li>
          <li className='flex items-center '>
            <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-blue-600"><svg width="16" height="13" viewBox="0 0 16 13" className="fill-current"><path d="M5.8535 12.6631C5.65824 12.8584 5.34166 12.8584 5.1464 12.6631L0.678505 8.1952C0.483242 7.99994 0.483242 7.68336 0.678505 7.4881L2.32921 5.83739C2.52467 5.64193 2.84166 5.64216 3.03684 5.83791L5.14622 7.95354C5.34147 8.14936 5.65859 8.14952 5.85403 7.95388L13.3797 0.420561C13.575 0.22513 13.8917 0.225051 14.087 0.420383L15.7381 2.07143C15.9333 2.26669 15.9333 2.58327 15.7381 2.77854L5.8535 12.6631Z"></path></svg></span>
            <span className='text-[25px]  text-gray-600'>Developer friendly</span>
          </li>
        </ul>
      </div>
      <div className='h-12/12'>
        <img src="https://themewagon.github.io/startup-nextjs/images/about/about-image.svg" alt=""  />
      </div>
    </div>
...
<span className='border-[1px] border-gray-300 w-full'></span>
    ...
    <div className=' w-full my-30 grid grid-cols-2 mx-20 gap-20'>
      <div className='h-12/12'>
        <img src="https://themewagon.github.io/startup-nextjs/images/about/about-image-2.svg" alt=""  />
      </div>
      <div className=' h-12/12'>
{/* <h1 className='text-gray-900 font-bold text-[50px] leading-tight w-4/5'>Crafted for Startup, SaaS and Business Sites.</h1>
        <h3 className='text-gray-600 mt-5  text-[25px] tracking-tight'>The main ‘thrust’ is to focus on educating attendees on how to best protect highly vulnerable business applications with interactive panel discussions and roundtables.</h3> */}
        <ul className='grid grid-cols-1 gap-5'>
            <li>
              <h1 className='text-gray-900 text-2xl font-bold '>Bug Free Code</h1>
              <h3 className='text-gray-600 mt-5  text-[25px] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h3>
            </li>
            <li>
              <h1 className='text-gray-900 text-2xl font-bold '>Premier support</h1>
              <h3 className='text-gray-600 mt-5  text-[25px] '>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</h3>
            </li>
            <li>
              <h1 className='text-gray-900 text-2xl font-bold '>Next.js</h1>
              <h3 className='text-gray-600 mt-5  text-[25px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</h3>
            </li>
        </ul>
      </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-1 place-items-center">
        ...
        <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-3 sm:gap-y-16 xl:col-span-2">
            <li className='flex flex-col gap-5 shadow-md shadow-gray-500 p-5'>
              ...
              <span className='text-lg/8 text-gray-600'>
        ...
        <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-3 sm:gap-y-16 xl:col-span-2">
            <li className='flex flex-col gap-15 shadow-md shadow-gray-500 p-10'>
              <div className='flex justify-between items-center'>
                <span className='text-3xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-4xl'>$40/mo</span>
                <span className='text-lg/8 text-gray-600'>Lite</span>
              </div>
              <span className='text-lg/8 text-gray-600'>
  ...
  <button className='ease-in-up hidden rounded-sm bg-primary px-8 py-3 text-center font-medium h-12 bg-blue-600 text-white  hover:opacity-75  md:block transition duration-300 '>Start Free Trail</button>
            ...
            <li className='flex flex-col gap-15 shadow-md shadow-gray-500 p-10'>
              ...
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span></span><span className='text-lg/8 text-gray-600'>Email Support </span></div>
              <div className='flex items-center'>
              <span class="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" class="fill-current h-4"><path d="M2.90567 6.00024C2.68031 6.00024 2.48715 5.92812 2.294 5.74764L0.169254 3.43784C-0.0560926 3.18523 -0.0560926 2.78827 0.169254 2.53566C0.39461 2.28298 0.74873 2.28298 0.974086 2.53566L2.90567 4.66497L7.02642 0.189715C7.25175 -0.062913 7.60585 -0.062913 7.83118 0.189715C8.0566 0.442354 8.0566 0.839355 7.83118 1.09198L3.54957 5.78375C3.32415 5.92812 3.09882 6.00024 2.90567 6.00024Z"></path></svg><span></span><span></span></span><span className='text-lg/8 text-gray-600'>Lifetime Access</span></div>
              <div className='flex items-center'>
              <span className="mr-3 flex h-[18px] w-full max-w-[18px] items-center  justify-center rounded-full bg-blue-200 bg-opacity-10 text-blue-500"><svg width="8" height="6" viewBox="0 0 8 6" className="fill-current h-4"><path d="M7.4499 0.512524C7.1124 0.175024 6.5874 0.175024 6.2499 0.512524L3.9999 2.80002L1.7124 0.512524C1.3749 0.175024 0.849902 0.175024 0.512402 0.512524C0.174902 0.850024 0.174902 1.37502 0.512402 1.71252L2.7999 4.00002L0.512402 6.28752C0.174902 6.62502 0.174902 7.15002 0.512402 7.48752C0.662402 7.63752 0.887402 7.75002 1.1124 7.75002C1.3374 7.75002 1.5624 7.67502 1.7124 7.48752L3.9999 5.20002L6.2874 7.48752C6.4374 7.63752 6.6624 7.75002 6.8874 7.75002C7.1124 7.75002 7.3374 7.67502 7.4874 7.48752C7.8249 7.15002 7.8249 6.62502 7.4874 6.28752L5.1999 4.00002L7.4874 1.71252C7.7874 1.37502 7.7874 0.850024 7.4499 0.512524Z"></path></svg><span></span></span><span className='text-lg/8 text-gray-600'>Free Lifetime Updates</span></div>
              </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:px-8 xl:grid-cols-1 place-items-center">
        ...
        <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-3 sm:gap-y-16 xl:col-span-2">
            <li className='flex flex-col gap-5 shadow-md shadow-gray-500 p-5'>
              ...
              <div className='flex'>
              <h1 className='text-gray-900 text-2xl font-bold'>Best UI components for modern websites</h1>  
              </div>
              <span className='text-lg/8 text-gray-600'>
            ...
            <li className='flex flex-col gap-5 shadow-md shadow-gray-500 p-5'>
              ...
              <div className='flex'>
                <h1 className='text-gray-900 text-2xl font-bold'>9 simple ways to improve your design skills</h1>  
              </div>
              <span className='text-lg/8 text-gray-600'>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sit amet dictum neque, laoreet dolor.
              </span>              
            ...
            <li className='flex flex-col gap-5 shadow-md shadow-gray-500 p-5'>
              ...
              <div className='flex'>
                  <h1 className='text-gray-900 text-2xl font-bold'>Tips to quickly improve your coding speed.</h1>  
              </div>
              <span className='text-lg/8 text-gray-600'>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras sit amet dictum neque, laoreet dolor.
              </span>
  ...
  <div className='flex sm:flex-row flex-col p-30 gap-10'>
    <div className='flex flex-col gap-10 p-4 shadow-md shadow-gray-500 w-2xs h-1/3 sm:p-10 sm:w-2/2'>
        <h1 className='text-gray-900 text-4xl font-bold text-center sm:text-start '>Need Help? Open a Ticket</h1>      
          <h3 className=" font-semibold tracking-tight text-pretty text-gray-500 text-2xl">
            Our support team will get back to you ASAP via email.
          </h3>
            <div className='flex flex-col gap-10 sm:flex-row'>
              
              <div className='flex flex-col'>                
              <label htmlFor="" className='text-gray-900'>Your Name</label>
              <input type="text" placeholder='Enter Your Name' className='border-2 w-3xs text-gray-500 border-gray-400 p-2 focus:border-blue-500 outline-0' />
              </div>

              <div className='flex flex-col'>
              <label htmlFor="" className='text-gray-900'>Your Email</label>
              <input type="email" className='border-2 w-3xs text-gray-500 border-gray-400 p-2 focus:border-blue-500 outline-0' placeholder='Enter Your Email' />
              </div>
            </div>
            <div className='flex flex-col'>
            <label htmlFor="" className='text-gray-900'>Your Message</label>
              <textarea name="" id="" rows={5} cols={5} className=' border-2 sm:w-2xl w-3xs text-gray-500 border-gray-400 p-2 focus:border-blue-500 outline-0'></textarea>
            </div>
    ...
    <div className='shadow-md shadow-gray-500 p-10 h-2xs flex flex-col gap-10 justify-around'>
        <h1 className='text-gray-900 text-2xl font-bold'>Subscribe to receive future updates</h1>      
          <h3 className=" font-semibold tracking-tight text-pretty text-gray-500 ">
        Lorem ipsum dolor sited Sed ullam corper consectur adipiscing Mae ornare massa quis lectus.
          ...
          <div className='flex flex-col gap-10 sm:flex-row'>
              ...
              <div className='flex flex-col'>                
              <label htmlFor="" className='text-gray-900'>Your Name</label>
              <input type="text" placeholder='Enter Your Name' className='border-2 sm:w-3xs text-gray-500 border-gray-400 p-2 focus:border-blue-500 outline-0' />
              </div>

              <div className='flex flex-col'>
              <label htmlFor="" className='text-gray-900'>Your Email</label>
              <input type="email" className='border-2 sm:w-3xs text-gray-500 border-gray-400 p-2 focus:border-blue-500 outline-0' placeholder='Enter Your Email' />
              </div>
            </div>
          ...
          <h3 className=" font-semibold tracking-tight text-pretty text-gray-500 text-center sm:text-start">
...
<div className=' flex justify-around items-center  gap-5'>
      ...
      <div className='w-2xs flex flex-col p-2 gap-5'>
        ...
        <span className=' leading-tight font-semibold tracking-tight text-pretty text-gray-500 text-center sm:text-start'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lobortis.</span>
        

<div className="flex items-center "><a href="#" aria-label="social-link" className="mr-6 text-gray-500 duration-300 hover:text-blue-600 dark:text-body-color-dark dark:hover:text-blue-600"><svg width="9" height="18" viewBox="0 0 9 18" className="fill-current"><path d="M8.13643 7H6.78036H6.29605V6.43548V4.68548V4.12097H6.78036H7.79741C8.06378 4.12097 8.28172 3.89516 8.28172 3.55645V0.564516C8.28172 0.254032 8.088 0 7.79741 0H6.02968C4.11665 0 2.78479 1.58064 2.78479 3.92339V6.37903V6.94355H2.30048H0.65382C0.314802 6.94355 0 7.25403 0 7.70564V9.7379C0 10.1331 0.266371 10.5 0.65382 10.5H2.25205H2.73636V11.0645V16.7379C2.73636 17.1331 3.00273 17.5 3.39018 17.5H5.66644C5.81174 17.5 5.93281 17.4153 6.02968 17.3024C6.12654 17.1895 6.19919 16.9919 6.19919 16.8226V11.0927V10.5282H6.70771H7.79741C8.11222 10.5282 8.35437 10.3024 8.4028 9.96371V9.93548V9.90726L8.74182 7.95968C8.76604 7.7621 8.74182 7.53629 8.59653 7.31048C8.54809 7.16935 8.33016 7.02823 8.13643 7Z"></path></svg></a><a href="#" aria-label="social-link" className="mr-6 text-gray-500 duration-300 hover:text-blue-600 dark:text-body-color-dark dark:hover:text-blue-600"><svg width="19" height="14" viewBox="0 0 19 14" className="fill-current"><path d="M16.3024 2.26027L17.375 1.0274C17.6855 0.693493 17.7702 0.436644 17.7984 0.308219C16.9516 0.770548 16.1613 0.924658 15.6532 0.924658H15.4556L15.3427 0.821918C14.6653 0.282534 13.8185 0 12.9153 0C10.9395 0 9.3871 1.48973 9.3871 3.21062C9.3871 3.31336 9.3871 3.46747 9.41532 3.57021L9.5 4.0839L8.90726 4.05822C5.29435 3.95548 2.33065 1.13014 1.85081 0.642123C1.06048 1.92637 1.5121 3.15925 1.99194 3.92979L2.95161 5.36815L1.42742 4.5976C1.45565 5.67637 1.90726 6.52397 2.78226 7.14041L3.54435 7.65411L2.78226 7.93665C3.2621 9.24658 4.33468 9.78596 5.125 9.99144L6.16935 10.2483L5.18145 10.8647C3.60081 11.8921 1.625 11.8151 0.75 11.738C2.52823 12.8682 4.64516 13.125 6.1129 13.125C7.21371 13.125 8.03226 13.0223 8.22984 12.9452C16.1331 11.25 16.5 4.82877 16.5 3.54452V3.36473L16.6694 3.26199C17.629 2.44007 18.0242 2.00342 18.25 1.74658C18.1653 1.77226 18.0524 1.82363 17.9395 1.84932L16.3024 2.26027Z"></path></svg></a><a href="#" aria-label="social-link" className="mr-6 text-gray-500 duration-300 hover:text-blue-600 dark:text-body-color-dark dark:hover:text-blue-600"><svg width="18" height="14" viewBox="0 0 18 14" className="fill-current"><path d="M17.5058 2.07119C17.3068 1.2488 16.7099 0.609173 15.9423 0.395963C14.5778 7.26191e-08 9.0627 0 9.0627 0C9.0627 0 3.54766 7.26191e-08 2.18311 0.395963C1.41555 0.609173 0.818561 1.2488 0.619565 2.07119C0.25 3.56366 0.25 6.60953 0.25 6.60953C0.25 6.60953 0.25 9.68585 0.619565 11.1479C0.818561 11.9703 1.41555 12.6099 2.18311 12.8231C3.54766 13.2191 9.0627 13.2191 9.0627 13.2191C9.0627 13.2191 14.5778 13.2191 15.9423 12.8231C16.7099 12.6099 17.3068 11.9703 17.5058 11.1479C17.8754 9.68585 17.8754 6.60953 17.8754 6.60953C17.8754 6.60953 17.8754 3.56366 17.5058 2.07119ZM7.30016 9.44218V3.77687L11.8771 6.60953L7.30016 9.44218Z"></path></svg></a><a href="#" aria-label="social-link" className="text-gray-500 duration-300 hover:text-blue-600 dark:text-body-color-dark dark:hover:text-blue-600"><svg width="17" height="16" viewBox="0 0 17 16" className="fill-current"><path d="M15.2196 0H1.99991C1.37516 0 0.875366 0.497491 0.875366 1.11936V14.3029C0.875366 14.8999 1.37516 15.4222 1.99991 15.4222H15.1696C15.7943 15.4222 16.2941 14.9247 16.2941 14.3029V1.09448C16.3441 0.497491 15.8443 0 15.2196 0ZM5.44852 13.1089H3.17444V5.7709H5.44852V13.1089ZM4.29899 4.75104C3.54929 4.75104 2.97452 4.15405 2.97452 3.43269C2.97452 2.71133 3.57428 2.11434 4.29899 2.11434C5.02369 2.11434 5.62345 2.71133 5.62345 3.43269C5.62345 4.15405 5.07367 4.75104 4.29899 4.75104ZM14.07 13.1089H11.796V9.55183C11.796 8.7061 11.771 7.58674 10.5964 7.58674C9.39693 7.58674 9.222 8.53198 9.222 9.47721V13.1089H6.94792V5.7709H9.17202V6.79076H9.19701C9.52188 6.19377 10.2466 5.59678 11.3711 5.59678C13.6952 5.59678 14.12 7.08925 14.12 9.12897V13.1089H14.07Z"></path></svg></a></div>

</div>

<div className=' w-2xs flex flex-col p-2 gap-7'>
   <h1 className='text-gray-900 text-2xl font-bold'>Useful Links</h1>
    <ul className='flex flex-col  gap-3'>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>Blog</li>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>Pricing</li>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>About</li>
    </ul>
</div>
      <div className=' w-2xs flex flex-col p-2 gap-7'>
      <h1 className='text-gray-900 text-2xl font-bold'>Terms</h1>
    <ul className='flex flex-col  gap-3'>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>TOS</li>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>Privicy Policy</li>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>Refund Fund</li>
    </ul>
      </div>
      ...
      <h1 className='text-gray-900 text-2xl font-bold'>Support & Help</h1>
    <ul className='flex flex-col  gap-3'>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>Open Support Ticket</li>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>Term of use</li>
      <li className='text-gray-500 hover:text-blue-600 hover:cursor-pointer transition duration-300'>About</li>
    </ul>
      </div>
